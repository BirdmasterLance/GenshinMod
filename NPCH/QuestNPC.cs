...
{
    // The Daily Commissions NPC
    internal class QuestNPC : ModNPC
    {
        ...
        public static void UpdateTravelingMerchant()
        {
            ...
            {
                int newTraveler = NPC.NewNPC(Terraria.Entity.GetSource_TownSpawn(), Main.spawnTileX * 16, Main.spawnTileY * 16, ModContent.NPCType<QuestNPC>(), 1); // Spawning at the world spawn
                ...
                spawnTime = double.MaxValue;// The idea is to spawn about 4
        ...
        public override string GetChat()
        {
            ...
            if (hivePackDialogue.Equals(dialogueLine))
            {
                ...
                Main.npcChatCornerItem = ItemID.HiveBackpack;//Here, the item to be added for finding
            }
        ...
        {
            button = Language.GetTextValue("Quest"/*"LegacyInterface.28"*/);
            if (Main.LocalPlayer.HasItem(ItemID.HiveBackpack))
            {
                button = "Quest " + Lang.GetItemNameValue(ItemID.HiveBackpack);
            }
        }
        ...
        public override void OnChatButtonClicked(bool firstButton, ref bool shop)
        {
            if (firstButton)
            {
                ...
                if (Main.LocalPlayer.HasItem(ItemID.HiveBackpack))// Hive pack is an example, should change with our item
                {
